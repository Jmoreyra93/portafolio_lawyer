  ...
  return (
    <div className="bg-[#DDD4C3] shadow-inner text-black ">
      <div className="mx-20  grid max-w-2xl grid-cols-1 items-center gap-y-16 gap-x-8 py-24 max-lg:px-8 px-24 sm:px-2 sm:py-10 lg:max-w-7xl lg:px-4">
        ...
        <div className="bg-[#DBC48E] rounded-md p-4">
          <p className="mt-4 text-2xl max-lg:text-base 	 text-stone-800">
          ...
          <dl className="mt-16 px-28 grid gap-x-6 gap-y-10 sm:grid-cols-2 max-lg:grid-cols-1 sm:gap-y-16 lg:gap-x-8 max-lg:px-4">
            {features.map((feature) => (
              <div key={feature.name} className="border-gray-200 pt-4">
                <dt className="text-lg flex justify-center items-center	h-28 shadow-md hover:shadow-lg rounded-md	font-bold	 text-center text-gray-900 max-lg:text-base ">{feature.name}</dt>
